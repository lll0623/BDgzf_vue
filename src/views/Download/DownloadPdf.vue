            ...
            <div class="first_page_wrapper rel">
                ...
                <div class="first_page">
                    ...
                    <div class='first_page_3'>
                        ...
                        <p class="marB20">
                            <span>{{name}}</span>
                            已与我单位（组织机构代码：<span>{{USCCode}}</span>）
                            签订
                    ...
                    <div class="section_one">
                        ...
                        <ul class="clearfix fir_ul">
                            ...
                            <li class="last_child">
                                ...
                                <span v-show="roomLists[0].Area!=0">{{roomLists[0].Area}}</span>
                                平方米
                            </li>
                        </ul>
                        <ul class="clearfix fir_ul">
                    ...
                    <div class="section_one">
                        ...
                        <ul class="clearfix fir_ul">
                            ...
                            <li class="last_child">
                                ...
                                <span v-show="roomLists[1].Area!=0">{{roomLists[1].Area}}</span>
                                平方米
                            </li>
                        </ul>
                        <ul class="clearfix fir_ul">
                    ...
                    <div class="section_one">
                        ...
                        <ul class="clearfix fir_ul">
                            ...
                            <li class="last_child">
                                ...
                                <span v-show="roomLists[4].Area!=0">{{roomLists[1].Area}}</span>
                                平方米
                            </li>
                        </ul>
                        <ul class="clearfix fir_ul">
...
<script>
    import {getApplyForInfo} from '../../api/api.js'
    export default {
        data(){
            return {
                htmlTitle: '提交申请pdf',
        ...
        methods:{
            getApplyForInfoFunc(){
                getApplyForInfo({Id:this.$cookie.get('applyForCode')}).then(response=>{
                    if(response.StatusCode == 200) {
                        ...
                        for(var i = 0;i<data.roomlist.length;i++){
                            ...
                            console.log(data.roomlist[i].PropertyType)
