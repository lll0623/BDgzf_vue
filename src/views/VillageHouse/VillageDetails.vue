		...
		<div class="screen-search-breadcrumb">
			...
			<div class="clearfix search-breadcrumb">
				<el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb_nav fl">
					...
					<el-breadcrumb-item :to="{ path: '/villageLists' }">小区列表</el-breadcrumb-item>
					<el-breadcrumb-item>小区详情</el-breadcrumb-item>
				</el-breadcrumb>
			</div>
		</div>
		<div class="villageDetails-item-top pad15" id="anchor-0">
			...
			<div class="villageDetails-item-top-cont clearfix">
				...
				<div class="fl villageDetails-item-top-cont-sec">
					<h5 class="bold fs16 c-3">小区基本信息</h5>
					<div class="clearfix village-info-fir">
						<p class="fl c-6">剩余<strong class="red fs40">{{residueHouse}}</strong>套可租房源</p>
						<router-link class="fr block c-6" :to="{path:'/houseLists',query: {id: villageId}}">查看该小区房源&gt;&gt;</router-link>
					</div>
...
import { getVillageDetails } from '../../api/api.js'
